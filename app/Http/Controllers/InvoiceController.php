...
class InvoiceController extends Controller
{
    public function show($id)
    {
        ...
        if(Auth::user()->akses == 'wali'){
            $data['tagihan'] = Tagihan::waliAnanda()->findOrFail($id);
        }
        ...
        if(request('output') == 'pdf'){
            ...
            $namaFile = 'invoice tagihan '.$data['tagihan']->ananda->nama.' bulan '.$data['tagihan']->tanggal_tagihan->translatedFormat('d F Y').'.pdf';
