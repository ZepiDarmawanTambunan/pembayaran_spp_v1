...
class PembayaranKonfirmasiNotification extends Notification
{
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'messages' => 'Pembayaran Tagihan atas nama '.$this->pembayaran->tagihan->ananda->nama.' telah dikonfirmasi.',
    ...
    public function toWhacenter($notifiable)
    {
        ...
        return (new WhacenterService())
            ...
            $this->pembayaran->tagihan->ananda->nama.' sebesar '.formatRupiah($this->pembayaran->jumlah_dibayar));
    }
}
